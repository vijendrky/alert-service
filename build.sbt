...
lazy val artifacts = new {
  ...
  val akkaHttp = Seq(
    ...
    "org.scalikejdbc" %% "scalikejdbc" % scalikejdbcV % "provided",
    "org.scalikejdbc" %% "scalikejdbc-config" % scalikejdbcV % "provided",
    "args4j" %% "args4j" % argsV
  )
